...
export class UserService {
  ...
  public updateUser(oldUsername: string | undefined, newUser: User): Observable<User> {
    return this.http.put<User>(`${this.apiServerUrl}/users/update/` + oldUsername, newUser);
  }
}
